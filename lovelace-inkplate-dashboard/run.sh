...
export SHARPEN=$(bashio::config 'SHARPEN')
export DITHER=$(bashio::config 'DITHER')
export DITHER_ALGO=$(bashio::config 'DITHER_ALGO')
export BLACK_LEVEL=$(bashio::config 'BLACK_LEVEL')
export WHITE_LEVEL=$(bashio::config 'WHITE_LEVEL')
